#  File tests/testthat/test-drop.R in package ergm.ego, part of the Statnet suite
...
test_that("dropped ergm terms", {
  ...
  expect_equal(coef(ergm(nw~edges+nodematch("a"))), out.coef, tolerance=0.01, ignore_attr=TRUE)
})
